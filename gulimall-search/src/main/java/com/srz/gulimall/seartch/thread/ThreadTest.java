...
//            System.out.println("运行结果：" + i);
//            return i;
//        }, executor).whenComplete((res,execution)->{
//            //虽然能得到异常信息，但是没法修改返回数据。
//            System.out.println("异步任务完成了,结果："+res+"异常："+execution);
...
//        });
         ...
         *  }, executor);
         *
         *  2、.thenAcceptAsync能接收上一步的结果，但是无返回值
         *  3、.thenAcceptAsync能接收上一步的结果，有返回值
         *
         */
